...
[<table style="border-spacing: 0; border-collapse: separate; border-radius: 10px;"><tbody><tr><td style="background: #4f4f4f; color: #ffffff; border-top-left-radius: 5px; border-bottom-left-radius: 5px;"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2c/Visual_Studio_Icon_2022.svg/193px-Visual_Studio_Icon_2022.svg.png" alt="Visual Studio 2022" width="24px" height="24px">Visual Studio C#</td><td style="background: linear-gradient(0deg, rgba(91,65,138,1) 0%, rgba(207,152,251,1) 100%); color: #ffffff; border-top-right-radius: 5px; border-bottom-right-radius: 5px;"><div style="margin-left: 5px; margin-right: 5px;">v17.4.2 APS.NET</div></td></tr></tbody></table>](https://visualstudio.microsoft.com/es/vs/) [<table style="border-spacing: 0; border-collapse: separate; border-radius: 10px;"><tbody><tr><td style="background: linear-gradient(0deg, rgba(209,209,209,1) 0%, rgba(255,255,255,1) 100%); border-top-left-radius: 5px; border-bottom-left-radius: 5px;"><img src="https://www.edureka.co/blog/wp-content/uploads/2019/10/logo.png" alt="SQL Server Management" width="24px" height="24px"> SQL Server</td><td style="background: linear-gradient(0deg, rgba(240,170,81,1) 0%, rgba(253,227,102,1) 100%); border-top-right-radius: 5px; border-bottom-right-radius: 5px;"><div style="margin-left: 5px; margin-right: 5px;">v17.4.2 APS.NET</div></td></tr></tbody></table>](https://learn.microsoft.com/en-us/sql/ssms/sql-server-management-studio-ssms?view=sql-server-ver16) [<table style="border-spacing: 0; border-collapse: separate; border-radius: 10px;"><tbody><tr><td style="background: #f6df3d; border-top-left-radius: 5px; border-bottom-left-radius: 5px;"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/99/Unofficial_JavaScript_logo_2.svg/1200px-Unofficial_JavaScript_logo_2.svg.png" alt="JavaScript" width="24px" height="24px"> JavaScript</td><td style="background: linear-gradient(0deg, rgba(74,74,74,1) 0%, rgba(147,147,147,1) 100%); color: #ffffff; border-top-right-radius: 5px; border-bottom-right-radius: 5px;"><div style="margin-left: 5px; margin-right: 5px;">vES2019</div></td></tr></tbody></table>](https://developer.mozilla.org/es/docs/Web/JavaScript)
